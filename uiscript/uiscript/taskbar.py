...
AETHERFALL_STYLE = True
AETHERFALL_DARK = 0xff241326
AETHERFALL_GOLD = 0xffb98b3a
AETHERFALL_AETHER = 0xff2ea9d6
...
window = {
	...
	(
		{
			"name" : "Aetherfall_Taskbar_Backplate",
			"type" : "bar",
			"x" : 0,
			"y" : 0,
			"width" : SCREEN_WIDTH,
			"height" : 37,
			"color" : AETHERFALL_DARK,
		},
		{
			"name" : "Aetherfall_Taskbar_GoldLine",
			"type" : "bar",
			"x" : 0,
			"y" : 0,
			"width" : SCREEN_WIDTH,
			"height" : 1,
			"color" : AETHERFALL_GOLD,
		},
		{
			"name" : "Aetherfall_Taskbar_AetherLine",
			"type" : "bar",
			"x" : 0,
			"y" : 1,
			"width" : SCREEN_WIDTH,
			"height" : 1,
			"color" : AETHERFALL_AETHER,
		},
		## Board
		{
			"name" : "Base_Board_01",
