...
RACE_SURA_W		= 6
RACE_SHAMAN_M	= 7
RACE_EISENJAEGER_M = 8
RACE_EISENJAEGER_W = 9
RACE_AETHERBRUT_M = 10
RACE_AETHERBRUT_W = 11
...
FACE_IMAGE_DICT = {
	...
	RACE_EISENJAEGER_M : "d:/ymir work/ui/game/windows/face_assassin.sub",
	RACE_EISENJAEGER_W : "d:/ymir work/ui/game/windows/face_assassin.sub",
	RACE_AETHERBRUT_M : "d:/ymir work/ui/game/windows/face_sura.sub",
	RACE_AETHERBRUT_W : "d:/ymir work/ui/game/windows/face_sura.sub",
}
...
def __InitData():
	...
	# EISENJAEGER
	##############
	chrmgr.CreateRace(RACE_EISENJAEGER_W)
	chrmgr.SelectRace(RACE_EISENJAEGER_W)
	chrmgr.LoadLocalRaceData("msm/assassin_w.msm")
	SetIntroMotions(chr.MOTION_MODE_GENERAL, "d:/ymir work/pc/assassin/intro/")

	chrmgr.CreateRace(RACE_EISENJAEGER_M)
	chrmgr.SelectRace(RACE_EISENJAEGER_M)
	chrmgr.LoadLocalRaceData("msm/assassin_m.msm")
	SetIntroMotions(chr.MOTION_MODE_GENERAL, "d:/ymir work/pc2/assassin/intro/")
	...
	# AETHERBRUT
	##############
	chrmgr.CreateRace(RACE_AETHERBRUT_M)
	chrmgr.SelectRace(RACE_AETHERBRUT_M)
	chrmgr.LoadLocalRaceData("msm/sura_m.msm")
	SetIntroMotions(chr.MOTION_MODE_GENERAL, "d:/ymir work/pc/sura/intro/")

	chrmgr.CreateRace(RACE_AETHERBRUT_W)
	chrmgr.SelectRace(RACE_AETHERBRUT_W)
	chrmgr.LoadLocalRaceData("msm/sura_w.msm")
	SetIntroMotions(chr.MOTION_MODE_GENERAL, "d:/ymir work/pc2/sura/intro/")
...
def __LoadGameAssassin():
	...
	__LoadGameAssassinEx(RACE_EISENJAEGER_W, "d:/ymir work/pc/assassin/")
	__LoadGameAssassinEx(RACE_EISENJAEGER_M, "d:/ymir work/pc2/assassin/")

def __LoadGameSura():
	__LoadGameSuraEx(RACE_SURA_M, "d:/ymir work/pc/sura/")
	__LoadGameSuraEx(RACE_SURA_W, "d:/ymir work/pc2/sura/")
	__LoadGameSuraEx(RACE_AETHERBRUT_M, "d:/ymir work/pc/sura/")
	__LoadGameSuraEx(RACE_AETHERBRUT_W, "d:/ymir work/pc2/sura/")
