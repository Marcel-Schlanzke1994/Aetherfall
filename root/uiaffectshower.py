...
class AffectShower(ui.Window):
	...
	# Older clients may not export newer affect constants such as AFFECT_FIRE.
	client_compat.register_optional_constant(
		_AFFECT_TEMPLATE,
		chr,
		"AFFECT_FIRE",
		("SKILL_FIRE", "d:/ymir work/ui/skill/sura/hwayeom_03.sub"),
	)
